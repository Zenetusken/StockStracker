 ...
 * @param {boolean} volumeEnabled - Volume bars enabled
 * @param {Function} onToggleVolume - Toggle Volume
 * @param {boolean} volumeVisible - Volume bars visible
 * @param {Function} onToggleVolumeVisibility - Toggle Volume visibility
 */
    ...
    <div className="mb-4 p-4 bg-card border border-line rounded-lg shadow-lg">
      ...
      <div className="mb-4 pb-4 border-b border-line">
          ...
          {volumeEnabled && (
            <>
              <button
                ...
                onClick={onToggleVolumeVisibility}
        ...
        <div className="text-xs text-text-muted mt-2 pl-7">
          Shows trading volume at bottom of chart (green = up, red = down)
        </div>
      </div>
